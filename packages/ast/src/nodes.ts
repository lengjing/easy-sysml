...
export type SysMLAstNode =
  | NamespaceNode | PackageNode | MembershipNode | ImportNode
  | TypeNode | FeatureNode
  | SpecializationNode | FeatureTypingNode | MultiplicityNode
  | PartDefinitionNode | AttributeDefinitionNode | PortDefinitionNode
  | ActionDefinitionNode | StateDefinitionNode | RequirementDefinitionNode
  | ConstraintDefinitionNode
  | PartUsageNode | AttributeUsageNode | PortUsageNode
  | ActionUsageNode | StateUsageNode | ConnectionUsageNode | AllocationUsageNode
  | ExpressionNode | LiteralIntegerNode | LiteralRealNode
  | LiteralStringNode | LiteralBooleanNode
  | CommentNode | DocumentationNode;
