...
import { createPackage, createPartDefinition, createPartUsage } from '@easy-sysml/ast';

// Helper to create minimal semantic result
function createMinimalSemantics(): SemanticAnalysisResult {
  return {
...
describe('ValidationEngine', () => {
  ...
  it('should detect naming violations', () => {
    ...
    const namingWarnings = result.diagnostics.filter(
      d => d.code === 'sysml.naming.definition-uppercase'
    );
